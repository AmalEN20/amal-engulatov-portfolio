  ...
  return (
    <main className="contact-page">
      <section className="container-shell contact-hero">
        ...
        <div className="contact-details reveal-up"><div><span className="eyebrow">Email</span><a href="mailto:amal.engulatov1@gmail.com">amal.engulatov1@gmail.com ↗</a></div><div><span className="eyebrow">Socials</span><p><a href="https://www.linkedin.com/in/amal-engulatov-18b144277/" target="_blank" rel="noreferrer">LinkedIn ↗</a><a href="https://github.com/AmalEN20?tab=repositories" target="_blank" rel="noreferrer">GitHub ↗</a></p></div><div><span className="eyebrow">Availability</span><p>Open to AI engineering roles, collaborations, and thoughtful product conversations.</p></div></div>
      </section>
